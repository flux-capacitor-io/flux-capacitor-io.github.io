...
how to let applications communicate reliably and easily without the need for complex infrastructure like message queues,
...
* _Application metrics:_ you can trace the performance of all connected services without any hassle.
